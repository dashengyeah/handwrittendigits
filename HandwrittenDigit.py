...
y_pred_cls = tf.argmax(y_pred, axis=1)  # Show the real predict number like '2'
...
with tf.Session() as sess:
    ...
    np.save("./saves/savew_hl1.npy", savew_hl1)
    np.save("./saves/saveb_hl1.npy", saveb_hl1)
    np.save("./saves/savew_hl2.npy", savew_hl2)
    np.save("./saves/saveb_hl2.npy", saveb_hl2)
    np.save("./saves/savew_hl3.npy", savew_fc1)
    np.save("./saves/saveb_hl3.npy", saveb_fc1)
    np.save("./saves/savew_op.npy", savew_op)
    np.save("./saves/saveb_op.npy", saveb_op)
